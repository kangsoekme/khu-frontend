...
function Topbar({ onLogoClick, role }) {
  return (
    <>
      <div className="flex justify-between w-full h-full shadow xl:shadow-none xl:px-8 xl:pr-10">
        <div
          className="w-25 flex items-center justify-center lg:hidden"
          onClick={onLogoClick}
        >
          <img
            src="src/assets/img/khu-logo.png"
            alt=""
            srcset=""
            className="h-10"
          />
        ...
        <div className="flex items-center gap-5 pr-8 xl:pr-0">
